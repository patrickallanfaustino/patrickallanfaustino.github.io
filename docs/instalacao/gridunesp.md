...
!!! info "Testado em"
    ...
    - GROMACS: 2026.2
    - CUDA: 12 (sm_89)
    - Versão do contêiner: 2026.06.19

![Cluster gridUNESP](../assets/instalacao/gridunesp.png)
...
Para criar um contêiner, precisamos de dois arquivos: [gromacs-gpu.def](../assets/instalacao/gridunesp/gromacs-gpu.def) e [build.sh](../assets/instalacao/gridunesp/build.sh).

**[gromacs-gpu.def](../assets/instalacao/gridunesp/gromacs-gpu.def):**
```
Bootstrap: docker
...
No arquivo [build.sh](../assets/instalacao/gridunesp/build.sh), será enviado a tarefa de criar o contêiner para processamento do gridUNESP.

**[build.sh](../assets/instalacao/gridunesp/build.sh):**
```bash
#!/bin/bash
#SBATCH -t 23:30:00
...
**[md1.sh](../assets/instalacao/gridunesp/md1.sh):**
```bash
!/bin/bash
...
**[run1.sh](../assets/instalacao/gridunesp/run1.sh):**
```bash
#!/bin/bash
#SBATCH -t 23:50:00
